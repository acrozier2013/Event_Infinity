...
namespace Event_Infinity.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventTypeId,Description")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventTypeId,Description")] EventType eventType)
        {
            if (ModelState.IsValid)
            {
